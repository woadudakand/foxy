          ...
          <Section>
            <NavLink to="#">
              <One>
                <Row gutter={15}>
                  <Col md={24}>
                    <Work src={require('../../conponets/work/intro/blog-post.jpg')} percent={40} color="#547df9" />
                  </Col>
                </Row>
              </One>
              <One>
                <Row gutter={15}>
                  <Col md={24}>
                    <Work src={require('../../conponets/work/intro/blog-post.jpg')} percent={70} color="#a4d882" />
                  </Col>
                </Row>
              </One>
              <One>
                <Row gutter={15}>
                  <Col md={24}>
                    <Work src={require('../../conponets/work/intro/blog-post.jpg')} percent={60} color="#f6da40" />
                  </Col>
                </Row>
              </One>
            </NavLink>
